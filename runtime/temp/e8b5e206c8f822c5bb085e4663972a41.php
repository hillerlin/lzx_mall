	...
	<?php else: if(is_array($orderList) || $orderList instanceof \think\Collection || $orderList instanceof \think\Paginator): $i = 0; $__LIST__ = $orderList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
  	<tr data-order-id="<?php echo $list['order_id']; ?>" id="<?php echo $list['order_id']; ?>">
        ...
        <td align="left" abbr="consignee" axis="col4" class="">
            <div style="text-align: left; width: 120px;" class=""><?php echo $list['nickname']; ?></div>
        </td>
        <td align="left" abbr="consignee" axis="col4" class="">
        ...
        <td align="center" abbr="article_time" axis="col6" class="">
          <div style="text-align: center; width: 60px;" class=""><?php echo $order_status[$list[order_status]]; ?></div>
        </td>
        <td align="center" abbr="article_time" axis="col6" class="">
        ...
        <td align="center" abbr="article_time" axis="col6" class="">
            <?php if(($list['shipping_status'] >= 1 && $list['shipping_name'] == '') && ($list['pay_status'] >= 1 || ($list['pay_status'] == 0 && $list['pay_code']))): ?>
		...
		<td style="width: 100%;">
            <div style="text-align: left; ">
                <a class="btn green" href="<?php echo U('Admin/order/detail',array('order_id'=>$list['order_id'])); ?>">查看</a>
