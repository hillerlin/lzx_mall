<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"./application/admin/view/wechat\setting.html";i:1568702273;s:68:"D:\wamp\www\tpshop_cyb\www\application\admin\view\public\layout.html";i:1568702273;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
  ...
  <form class="form-horizontal" method="post" id="handlepost" action="">    
    <div class="ncap-form-default">
	  ...
	  <dl class="row">
        <dt class="tit">
          <label>订单通知openid</label> 
        </dt>
        <dd class="opt">
          <input type="text" name="bell_openid" value="<?php echo $wechat['bell_openid']; ?>" class="input-txt">
          <span class="err"></span>
		  <p class="notic">多个openid通知接收人请用竖线"|"隔开</p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
