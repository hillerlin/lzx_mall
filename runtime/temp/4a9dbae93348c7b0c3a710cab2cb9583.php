<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:44:"./application/admin/view/user\ajaxindex.html";i:1568702273;}*/ ?>
            ...
            <tr data-id="<?php echo $list['user_id']; ?>">
                ...
                <td align="center" class="handle">
                    <div style="text-align: center; width: 170px; max-width:250px;">
                        <a class="btn blue" href="<?php echo U('Admin/user/detail',array('id'=>$list['user_id'])); ?>">详情</a>
                        <a class="btn blue" href="<?php echo U('Admin/user/account_log',array('id'=>$list['user_id'])); ?>">资金</a>
                        <a class="btn blue" href="<?php echo U('Admin/user/address',array('id'=>$list['user_id'])); ?>">收货地址</a>
                    </div>
                </td>
