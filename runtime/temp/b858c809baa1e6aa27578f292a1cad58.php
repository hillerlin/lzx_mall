<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/view/system\shop_info.html";i:1568702273;s:68:"D:\wamp\www\tpshop_cyb\www\application\admin\view\public\layout.html";i:1568702273;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <form method="post" id="handlepost" action="<?php echo U('System/handle'); ?>" enctype="multipart/form-data" name="form1">
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                <dt class="tit">
                        <label for="record_no">官网域名信息 http://</label>
                </dt>
                <dd class="opt">
                    <input id="domain_name" name="domain_name" value="<?php echo $config['domain_name']; ?>" class="input-txt" type="text" />
                    <p class="notic">官网域名信息，将显示在当前网站相关信息等位置</p>
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
                    <label for="record_no">版权信息</label>
                </dt>
                <dd class="opt">
                    <input id="copyright" name="copyright" value="<?php echo $config['copyright']; ?>" class="input-txt" type="text" />
                    <p class="notic">版权信息，将显示在当前网站相关信息等位置</p>
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
                    <label for="record_no">版权所属公司名称</label>
                </dt>
                <dd class="opt">
                    <input id="company" name="company" value="<?php echo $config['company']; ?>" class="input-txt" type="text" />
                    <p class="notic">版权所属公司，将显示在当前网站相关信息等位置</p>
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
