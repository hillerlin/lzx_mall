<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./application/admin/view/order\index.html";i:1568702273;s:68:"D:\wamp\www\tpshop_cyb\www\application\admin\view\public\layout.html";i:1568702273;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        ...
        <a href="http://help.tp-shop.cn/Index/Help/info/cat_id/5/id/41.html" style="display: <?php echo tpCache('basic.is_manual')?'block':'none'; ?>"  class="manual" target="_blank"><i class="fa fa-calendar"></i>帮助手册</a>
  ...
  <div class="flexigrid">
    <div class="mDiv">
      ...
      <div class="fbutton"> <!--<a href="/index.php?m=Admin&c=Order&a=add_order"><div class="add" title="添加订单"><span><i class="fa fa-plus"></i>添加订单</span></div></a> --></div>
      ...
      <div class="sDiv">
        <div class="sDiv2">
        	<input type="text" size="30" id="start_time" name="start_time" value="<?php echo $start_time; ?>" class="qsbox"  placeholder="下单开始时间" autocomplete="off">
        </div>
        <div class="sDiv2">
        	<input type="text" size="30" id="end_time" name="end_time" value="<?php echo $end_time; ?>" class="qsbox"  placeholder="下单结束时间" autocomplete="off">
        </div>
        <div class="sDiv2">	 
