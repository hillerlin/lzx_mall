<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:49:"./application/admin/view/goods\ajaxGoodsList.html";i:1568702273;}*/ ?>
<table>
       <tbody>
			 ...
			 <td class="handle" >
                <div style="text-align:left;   min-width:50px !important; max-width:inherit !important;">
                  ...
                  <ul>
                    ...
                    <li><a href="<?php echo U('Admin/Goods/addEditGoods',array('id'=>$list['goods_id'],'type'=>'copy')); ?>">复制商品</a></li>
                    <li><a href="<?php echo U('Admin/Goods/addEditGoods',array('id'=>$list['goods_id'],'type'=>'edit')); ?>">编辑商品</a></li>
                    ...
                    <li><a href="javascript:void(0);" data-id="<?php echo $list[goods_id]; ?>" onclick="add_comment(this)">添加商品评论</a></li>
                  </ul>
                  </span>
                </div>
              </td>                
                ...
                <td align="center" axis="col0">
                  <div style="text-align: left; width: 300px;"><?php if($list[is_virtual] == 1): ?><span class="type-virtual" title="虚拟兑换商品">虚拟</span><?php endif; ?><?php echo getSubstr($list['goods_name'],0,33); ?></div>
                </td>
                <td align="center" axis="col0">
                  <div style="text-align: center; width: 100px;"><?php echo $list['goods_sn']; ?></div>
                </td>
				<td align="center" axis="col0">
                  <div style="text-align: center; width: 100px;"><?php echo !empty($supplier_list[$list['suppliers_id']])?$supplier_list[$list['suppliers_id']]: '-'; ?></div>
                </td>
                <td align="center" axis="col0">
