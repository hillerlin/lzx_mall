<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:41:"./application/admin/view/admin\login.html";i:1568702273;}*/ ?>
<!doctype html>
...
<body>
	<div class="login-layout">
    	<div class="logo">
            <img src="<?php echo (isset($tpshop_config['shop_info_admin_login_logo']) && ($tpshop_config['shop_info_admin_login_logo'] !== '')?$tpshop_config['shop_info_admin_login_logo']:'/public/static/images/logo/admin_login_logo_default.png'); ?>" width="220">
        </div>
