<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./application/admin/view/report\index.html";i:1568702273;s:68:"D:\wamp\www\tpshop_cyb\www\application\admin\view\public\layout.html";i:1568702273;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
	...
	<div class="flexigrid">
		<div class="mDiv">
			...
			<form class="navbar-form form-inline" id="search-form" method="get" action="<?php echo U('Report/index'); ?>" >
				<div class="sDiv">
						...
						<tr data-time="<?php echo $vo['day']; ?>">
							...
							<td align="center" class="handle">
								<div style="text-align: center; width: 170px; max-width:170px;">
									<a href="<?php echo U('Report/saleOrder',array('start_time'=>$vo['day'],'end_time'=>$vo['end'])); ?>" class="btn blue"></i>查看订单列表</a>
								</div>
							</td>
