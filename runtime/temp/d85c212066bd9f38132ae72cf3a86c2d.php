<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:40:"./application/admin/view/user\index.html";i:1568702273;s:68:"D:\wamp\www\tpshop_cyb\www\application\admin\view\public\layout.html";i:1568702273;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <div class="flexigrid">
        <div class="mDiv">
            ...
            <div class="fbutton"><a href="<?php echo U('User/add_user'); ?>"><div class="add" title="添加会员"><span><i class="fa fa-plus"></i>添加会员</span></div></a></div>
            <div class="fbutton"><a href="javascript:;" onclick="exportUser()"><div class="add" title="导出会员"><span><i class="fa fa-share"></i>导出会员</span></div></a></div>
            <div class="fbutton"><a onclick="send_message();"><div class="add" title="发送站内信"><span><i class="fa fa-send"></i>发送站内信</span></div></a></div>
            <div class="fbutton"><a onclick="send_mail();"><div class="add" title="发送邮件"><span><i class="fa fa-send-o"></i>发送邮件</span></div></a></div>
            ...
            <form class="navbar-form form-inline" method="post"  id="search-form2">
                ...
                <div class="sDiv">
                    <div class="sDiv2">
                        <input type="text" size="30" id="start_time" name="start_time" value="" class="qsbox"  placeholder="注册开始时间" autocomplete="off">
                    </div>
                    <div class="sDiv2">
                        <input type="text" size="30" id="end_time" name="end_time" value="" class="qsbox"  placeholder="注册结束时间" autocomplete="off">
                    </div>
                    <div class="sDiv2">
