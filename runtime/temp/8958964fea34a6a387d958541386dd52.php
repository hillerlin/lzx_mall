<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"./application/admin/view/goods\goodsList.html";i:1568702273;s:68:"D:\wamp\www\tpshop_cyb\www\application\admin\view\public\layout.html";i:1568702273;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
  ...
  <div class="flexigrid">
        <div class="mDiv">
            ...
            <div class="fbutton"><a href="<?php echo U('Admin/goods/addEditGoods'); ?>"><div class="add" title="添加商品"><span><i class="fa fa-plus"></i>添加商品</span></div></a></div> 
            <div class="fbutton"><a href="javascript:;" onclick="publicHandleAll('del')"><div class="add" title="批量删除"><span>批量删除</span></div></a></div>
        	<div class="fbutton"><a href="<?php echo U('Admin/Goods/initGoodsSearchWord'); ?>"><div class="add" title="初始化商品搜索关键词"><span>初始化商品搜索关键词</span></div></a></div>
        	<div class="fbutton"><a href="javascript:;" onclick="export_goods()"><div class="add" title="未选择时根据搜索条件导出"><span>导出商品</span></div></a></div>
