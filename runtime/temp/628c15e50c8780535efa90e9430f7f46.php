<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:43:"./application/admin/view/index\welcome.html";i:1568702273;}*/ ?>
<html>
<head>
...
<div class="warpper">
	<div class="index-leftpt">
    	<div class="index-bisinfo">
        	<h3>基本信息<em>单商家版</em></h3>
            <div class="bisinfo-con">
            	<span>店铺名称：<b><?php echo $tpshop_config['shop_info_store_name']; ?></b></span>
                <!--<span>开通时间：<b>2018-01-01至2019-01-01</b></span>-->
                <!--<span>其他信息：<b>自定义</b></span>-->
            </div>
        </div>
