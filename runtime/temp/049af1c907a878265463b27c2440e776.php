<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:37:"./template/pc/rainbow/cart\cart4.html";i:1568861913;s:66:"D:\TPshop_tp5_20210401\template\pc\rainbow\public\sign-header.html";i:1568702283;s:61:"D:\TPshop_tp5_20210401\template\pc\rainbow\public\footer.html";i:1568702283;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="/template/pc/rainbow/static/css/pay.min.css">
    <link rel="stylesheet" type="text/css" href="/template/pc/rainbow/static/css/tpshop.css" />
    <link rel="stylesheet" type="text/css" href="/template/pc/rainbow/static/css/base.css"/>
    <link href="/template/pc/rainbow/static/css/common.min.css" rel="stylesheet" type="text/css"/>
    <link rel="stylesheet" href="/template/pc/rainbow/static/css/jh.css">
                                            ...
                                            <?php if(is_array($paymentList) || $paymentList instanceof \think\Collection || $paymentList instanceof \think\Paginator): if( count($paymentList)==0 ) : echo "" ;else: foreach($paymentList as $k=>$v): ?>
                                                <li>
                                                    <div class="payment-area">
                                                        ...
                                                        <label for="">
                                                            <img src="/plugins/<?php echo $v['type']; ?>/<?php echo $v['code']; ?>/<?php echo $v['icon']; ?>" width="40" height="40" onClick="change_pay(this);"/>
															<?php echo $v[name]; ?>
                                                        </label>
                                                    </div>
                                                </li>
